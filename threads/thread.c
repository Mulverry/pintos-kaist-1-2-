					...
					thread_func *function, void *aux)
{
	...
	fd1->fd = 1;
	list_push_front(&t->file_descriptors, &fd1->elem);

	struct file_descriptor *fd0 = palloc_get_page(0);
	fd0->fd = 0;
	list_push_back(&t->file_descriptors, &fd0->elem);
...
/* Yields the CPU.  The current thread is not put to sleep and
   may be scheduled again immediately at the schedests/threads/priority-donate-one.output
perl -I../.. ../../tests/threads/priority-donate-one.ckuler's whim. */
